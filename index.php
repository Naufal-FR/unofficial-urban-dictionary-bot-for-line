<?php
	...
	require_once('./src/LINEBotTiny.php');
	require_once('./func/bot_function.php');

	require_once('./text/channel_Key.php');
	require_once('./text/list_text.php');
						...
						try {
							...
							if (empty($term)) {
		                		...
		                		if ($term_array['result_type'] == "no_results") {
									...
									$text_response = format_return_text($term_array, $lookup_value, $variation, $exploded_Message[0], $tips_list);	
		                		}
